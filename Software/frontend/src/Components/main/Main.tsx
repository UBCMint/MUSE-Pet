    ...
    <>
      ...
      <body>
        <header className="masthead">
          <div className="main">
            <h1>Muse Tamagochis</h1>
            <h2>
              UBC Multifaceted Innovation in NeuroTechnology
              <br />
              <a
              ...
              <span> </span>
              <a
                href="https://www.instagram.com/ubcmint/?hl=en"
              ...
              <span> </span>
              <a
                href="https://www.youtube.com/@mintubc1309"
            ...
            <Link to="/login">
              <Button id="mainButton" variant="info">
                Start
              </Button>
            </Link>
          </div>
              ...
              <div className="col-lg-4">
                <div className="features-icons-item mx-auto mb-5 mb-lg-0 mb-lg-3 text-white">
                  <div className="features-icons-icon d-flex">
                    <i className="bi-window m-auto text-danger">
                      <FaBrain />
                    </i>
                  </div>
                  <h3>Brain Signals</h3>
                  <p className="lead mb-0 text-dark">
                    Get instant feedback from your Pet's brain.
                  </p>
                </div>
              </div>
              <div className="col-lg-4">
                <div className="features-icons-item mx-auto mb-5 mb-lg-0 mb-lg-3 text-white">
                  ...
                  <p className="lead mb-0 text-dark">
                    Featuring Compatible with the latest EEG technology.
                  </p>
                </div>
              </div>
              <div className="col-lg-4">
                <div className="features-icons-item mx-auto mb-0 mb-lg-3 text-white">
                  ...
                  <p className="lead mb-0 text-dark">
                    Track Alpha, Beta and Gamma Signals.
                  </p>
                </div>
              </div>
            </Row>
